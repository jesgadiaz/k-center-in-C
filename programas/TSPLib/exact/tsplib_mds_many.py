...
def run(output_file):
    ...
    out_file.write('        temp[1] = total_runtime\n')
    ...
    out_file.write('    global out_list\n')
    out_file.write('    global temp\n')
    out_file.write('    out_list = []\n')
    out_file.write('    for i in range(1, 16):\n')
    out_file.write('        temp = [0,0]\n')
    out_file.write('        k = i * 10\n')
    ...
    out_file.write('        temp[0]= min(mid_history)\n')
    out_file.write('        out_list.append(temp)\n')
    ...
    out_file.write('    for e in out_list:\n')
    out_file.write('        print(repr(e[0]) + "  " + repr(e[1]))\n')
